![](TestApproach_TechFlow_GSAAgileBPA_02-media/media/image1.gif)
...
-   Search Returns Label Information
    ...
    -   Verify that the system displays accurate drug label information
...
-   Search Return Adverse Events
    ...
    -   Verify that the system displays accurate adverse event
...
-   Search Returns Graphical Representation
    ...
    -   Verify that the system displays a bar chart that demonstrates
        the accurate adverse event information for the drug queried.
